    ...
    Geolocator.getPositionStream(
      ...
      if (streamlat.toStringAsFixed(2) == lat1.toStringAsFixed(2)
        ...
        Noti.showBigTextNotification(
            ...
            fln: flutterLocalNotificationsPlugin).timeout(Duration(milliseconds: 1000));
      }  else {
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              ...
                              // Text(
                              //   lineNumber == 0? stringNumber
                              //       : 'LINE ${lineNumber}',
                              //   style: TextStyle(
                              //       fontWeight: FontWeight.bold,
                              //       fontSize: countvalueN == 5? mainBoxHeight/31 : mainBoxHeight/21,    ///
                              //       color: Colors.white),
                              // ),
                              SizedBox(height: mainBoxHeight/25,),
                              Container(
